...
const EnhancedRegistrationForm = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (touched[name]) {
            const fieldError = validateField(name, type === 'checkbox' ?
                checked : value);
            setErrors(prev => ({
                ...prev,
                [name]: fieldError
        ...
        return (
            <div className={styles.container}>
                <div className={styles.successMessage}>
                    ...
                    <p>Thank you for registering. We've sent a confirmation email to
                        your inbox.</p>
                </div>
            </div>
        );
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                ...
                <div style={{
                    ...
                    <div className={styles.formGroup}>
                        ...
                        {formData.password && !errors.password && (
                            <div style={{
                                fontSize: '0.8rem', color: '#27ae60', marginTop:
                                    '0.5rem'
                            }}>
                ...
                <div style={{
                    ...
                    <ul style={{ margin: '0.5rem 0 0 1rem', padding: 0 }}>
                        <li style={{
                            color: formData.password.length >= 8 ? '#27ae60' :
                                '#7f8c8d'
                        }}>
                            At least 8 characters
                        </li>
                        <li style={{
                            color: /[a-z]/.test(formData.password) ? '#27ae60' :
                                '#7f8c8d'
                        }}>
                        ...
                        <li style={{
                            color: /[0-9]/.test(formData.password) ? '#27ae60' :
                                '#7f8c8d'
                        }}>
                            One number
                        </li>
                ...
                <div className={styles.formGroup}>
                    ...
                    {errors.agreeToTerms && <span style={{
                        color: '#e74c3c', fontSize:
                            '0.8rem'
